...
declare namespace Utils {
     ...
     */
    function className(...argument: any): void
     ...
     * @param {number} delay 
     */
    function debounce(executor: () => void, delay: number): void
     ...
     */
    function extend(extendee: object, ...extenders: object[]): object
     ...
     */
    function findInTree(tree: object, searchFilter: any, options: object): void
}
